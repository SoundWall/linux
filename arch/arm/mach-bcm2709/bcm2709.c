...
#if defined(CONFIG_SND_BCM2708_SOC_RPI_CODEC_PROTO)|| defined(CONFIG_SND_BCM2708_SOC_RPI_CODEC_PROTO_MODULE)
...
void __init bcm2709_init(void)
{
	...
	bcm_register_device_dt(&bcm2708_i2s_device);
        ...
        i2c_register_board_info_dt(1, snd_rpi_proto_i2c_devices, ARRAY_SIZE(snd_rpi_proto_i2c_devices));
#endif
